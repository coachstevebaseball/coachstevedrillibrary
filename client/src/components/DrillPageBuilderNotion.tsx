      ...
      <div className="container max-w-4xl py-6 md:py-8 px-4">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3 md:gap-4 min-w-0">
            <div className="h-10 w-10 md:h-12 md:w-12 rounded-xl bg-gradient-to-br from-[#C9A84C] to-purple-500 flex items-center justify-center shrink-0">
            ...
            <div className="min-w-0">
              <h1 className="text-lg md:text-2xl font-bold text-foreground flex items-center gap-2">
                Page Builder
                <span className="text-[10px] md:text-xs bg-[#C9A84C]/20 text-[#C9A84C] px-2 py-0.5 rounded-full whitespace-nowrap">
                  Notion-style
                </span>
              </h1>
        ...
        {blocks.length === 0 && !previewMode && (
          <div className="glass-card rounded-xl p-6 mb-6 border border-dashed border-[#C9A84C]/30 bg-[#C9A84C]/5">
            <div className="flex items-start gap-4">
              <div className="h-10 w-10 rounded-lg bg-[#C9A84C]/20 flex items-center justify-center shrink-0">
        ...
        {blocks.length > 0 && !previewMode && (
          <div className="px-4 py-2.5 mb-4 rounded-lg bg-white/[0.03] border border-white/[0.06]">
            <p className="text-xs text-muted-foreground flex items-center gap-2 flex-wrap">
              <Sparkles className="h-3.5 w-3.5 text-[#C9A84C] shrink-0" />
              <span>
                Type{" "}
          ...
          <DialogContent className="glass-card border-white/10">
            ...
            <DialogFooter>
              ...
              <Button
                ...
                className="bg-[#C9A84C] hover:bg-[#C9A84C]/80"
              >
                Save Template
              </Button>
            </DialogFooter>
