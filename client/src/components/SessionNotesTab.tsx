      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        {view === "list" && (
          <Button
            ...
            className="bg-[#C9A84C] hover:bg-[#C9A84C]/90 ml-auto"
          >
        ...
        {athletesWithSessions.map((a: any) => (
          ...
          >
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-full bg-gradient-to-br from-[#C9A84C]/20 to-[#C9A84C]/20 flex items-center justify-center shrink-0">
                <Users className="h-5 w-5 text-[#C9A84C]" />
              </div>
              <div className="min-w-0">
                <p className="font-heading font-bold text-sm truncate group-hover:text-[#C9A84C] transition-colors">
