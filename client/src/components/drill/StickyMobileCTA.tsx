    ...
    <div className="md:hidden fixed bottom-0 inset-x-0 z-40 border-t border-white/10 bg-[rgb(8,8,9)]/95 backdrop-blur-md pt-2 pb-3 px-3 flex gap-2 safe-area-bottom">
      {canMarkComplete && (
        <button
          ...
          className="flex-1 h-12 rounded-xl font-bold text-white text-sm flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed transition-all active:scale-95"
          style={{
            background:
      ...
      <Link href={`/athlete-portal?drillId=${encodeURIComponent(drillId)}#swing-analyzer`}>
        <a
          ...
          } h-12 rounded-xl font-bold text-white text-sm flex items-center justify-center gap-2 transition-all active:scale-95`}
          style={{
            background:
