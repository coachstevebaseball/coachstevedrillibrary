  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        ...
        <Badge className="bg-[#C9A84C]/20 text-[#C9A84C] border border-[#C9A84C]/30">
          {reports.length}
        </Badge>
      </div>
              ...
              <div className="px-4 pb-4 border-t border-white/[0.06]">
                <div
                  className={`
                    ...
                    [&_h1]:text-xl [&_h1]:font-bold [&_h1]:text-foreground [&_h1]:mb-3 [&_h1]:mt-4 [&_h1]:pb-2 [&_h1]:border-b [&_h1]:border-[#C9A84C]/30
                    ...
                    [&_blockquote]:border-l-4 [&_blockquote]:border-[#C9A84C]/40 [&_blockquote]:pl-4 [&_blockquote]:italic [&_blockquote]:text-foreground/60 [&_blockquote]:my-3
                  `}
