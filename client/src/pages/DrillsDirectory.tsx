...
import { Search, Filter, LogIn, LogOut, Shield, X, Users, Activity, ChevronDown, ArrowLeft } from "lucide-react";
...
export default function DrillsDirectory() {
  ...
  // Check if user is an active athlete (only applies to athletes, not admins/coaches)
