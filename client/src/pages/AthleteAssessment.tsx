      ...
      {data.map((d, i) => (
        <div key={i} className="flex-1 flex flex-col items-center gap-1">
          ...
          <div className="w-full bg-white/[0.06] rounded-t-md overflow-hidden" style={{ height: "100%" }}>
            <div
              className="w-full bg-gradient-to-t from-[#C9A84C] to-[#E8425A] rounded-t-md transition-all duration-500"
              style={{
...
function AssessmentReport({ athleteId, athleteName }: { athleteId: number; athleteName: string }) {
  ...
  return (
    <div ref={reportRef} className="space-y-6">
      {/* Report Header */}
      <div className="glass-card rounded-xl border-l-4 border-l-[#C9A84C] p-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-3 mb-1">
              <div className="h-10 w-10 rounded-full bg-gradient-to-br from-[#C9A84C]/20 to-purple-500/20 border border-white/[0.06] flex items-center justify-center">
          ...
          <div className="p-4 md:p-6 pt-0">
            <div className="space-y-4">
              {coachNotes.slice(0, 3).map((note: any, i: number) => (
                <div key={i} className="bg-white/[0.03] rounded-lg p-4 border-l-2 border-l-[#C9A84C]/50">
      ...
      {/* Recommendations */}
      <div className="glass-card rounded-xl border border-[#C9A84C]/20">
        <div className="p-4 md:p-6 pb-3">
          <h3 className="text-lg font-heading font-bold flex items-center gap-2">
            <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-[#C9A84C]/20 to-[#C9A84C]/20 flex items-center justify-center">
