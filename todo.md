...
- [x] Add "Invite Athletes" quick action card
- [x] Add "View Submissions" quick action card
- [x] Add "Send Bulk Email" quick action card
- [x] Create bulk email modal/page if not exists
- [x] Style cards with icons and hover effects
- [x] Test all quick action cards work correctly
